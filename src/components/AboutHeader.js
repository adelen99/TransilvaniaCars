      ...
      <div className='container mx-auto px-4'>
        ...
        <section className='mt-10 text-lg text-gray-800 leading-relaxed  '>
          ...
          <p className='mb-6'>
            ...
            la mașini compacte economice pentru oraș până la SUV-uri spațioase
            și confortabile pentru drumuri lungi, flota noastră acoperă toate
            cerințele dumneavoastră. Ne asigurăm că fiecare vehicul este
            verificat și întreținut regulat pentru a oferi performanțe optime.
            În plus, toate mașinile noastre sunt dotate cu cele mai recente
            tehnologii de siguranță și confort pentru a vă oferi o experiență de
            neuitat.
          </p>
          <div className='mb-6 container mx-auto flex justify-center items-center space-x-8 bg-yellow-200 rounded-xl py-12'>
            <div className='flex flex-col  items-center text-3xl px-8'>
          ...
          <p className='mb-6'>
            Ne mândrim cu transparența și corectitudinea în toate aspectele
            afacerii noastre. Nu există taxe ascunse, iar politica noastră clară
            de prețuri vă asigură că veți obține cea mai bună valoare pentru
            banii dumneavoastră. În plus, oferim diverse opțiuni de asigurare
            pentru a vă proteja pe dumneavoastră și pe cei dragi în timpul
            călătoriilor. Serviciul nostru de asistență rutieră 24/7 este
            disponibil pentru a vă oferi liniștea necesară pe parcursul fiecărei
            călătorii. Indiferent de problemă, echipa noastră este pregătită să
            intervină rapid și eficient pentru a vă asigura că totul merge
            conform planului.
          </p>
